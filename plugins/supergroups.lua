...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'setlinks' and is_owner(msg) then
		...
		if matches[1] == 'del' then
			...
			if matches[2] == 'banalllist' and is_sudo then 
            local hash = 'gbanned'
